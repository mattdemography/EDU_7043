...
#Let's Do Shapiro-Wilk Test on the Normal
#The Null is that the data are normal. So, if you get a value greater
#than 0.05, then you fail to reject the null. That is, your data
#are normal.
shapiro.test(rnorm(100, mean = 5, sd = 3))

#Let's Do Shapiro-Wilk Test on Our Real Data
shapiro.test(hiv01$hiv01)
